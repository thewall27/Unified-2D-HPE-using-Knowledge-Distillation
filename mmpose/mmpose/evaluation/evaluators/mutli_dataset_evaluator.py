    ...
    def __init__(
        ...
        for dataset, converter, metric in zip(datasets, converters, self.metrics):
            ...
            if converter is not None:
                converters_dict[dataset_meta['dataset_name']] = TRANSFORMS.build(converter)
            ...
            if dataset_name in _data_samples:
                ...
                if converter is not None:
                    ...
                    for sample in _data_samples[dataset_name]:
                        sample['gt_instances'] = converter(sample['gt_instances'])
                        sample['pred_instances'] = converter(sample['pred_instances'])
