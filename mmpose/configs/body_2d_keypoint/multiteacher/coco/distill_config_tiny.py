_base_ = [
    '../../rtmpose/coco/rtmpose-t_8xb256-420e_mpii-coco-256x192.py'
]
...
model = dict(
    ...
    student_cfg='mmpose/configs/body_2d_keypoint/rtmpose/coco/rtmpose-t_8xb256-420e_mpii-coco-256x192.py',
    distill_cfg=[
        dict(methods=[
            dict(
                type='KDLoss',
